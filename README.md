...
This repository includes a collection of every badge on GitHub, and how to obtain each one of them. Some of them are obtainable, some not, or still in beta testing. This repository orders the badges from `Very Easy` to `Easy` to `Medium` and finally `Hard`.
